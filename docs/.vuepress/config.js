...
module.exports = {
  ...
  themeConfig: {
    nav: [
      ...
      {
        text: '使用教程', link: '/pages/backup/', items: [
          { text: '如何备份数据', link: '/pages/backup/' },
          { text: '如何使用GPTs', link: '/pages/gptstore/' },
        ]
      },
    ...
    footer: { // 页脚信息
      ...
      copyrightInfo: '<a href="https://www.ppdd.ai/">ChatGPT CN</a>', // 博客版权信息，支持a标签
